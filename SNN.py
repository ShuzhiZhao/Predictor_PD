...
imge_size = 64*64*32*1
class SpikingNeuronLayerRNN(nn.Module):
    
    def __init__(self, device, n_inputs=imge_size, n_hidden=100, decay_multiplier=0.9, threshold=2.0, penalty_threshold=2.5):
...
class NonSpikingNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = nn.Linear(imge_size, 500)
